...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['NomCategorie']) && !empty($_POST['NomCategorie']) && isset($_POST['CategoryID'])) {
        ...
        try {
            $sql_update_category = "UPDATE categorieproduit SET NomCategorie = :NomCategorie , NomCategorie_ar = :NomCategorie_ar , NomCategorie_fr = :NomCategorie_fr WHERE CategoryID = :CategoryID";
