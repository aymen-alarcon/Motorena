<?php
    ...
    if(isset($_GET['CategoryID'])) {
        ...
        $sql = "SELECT * FROM categorieproduit WHERE CategoryID = :CategoryID";
...
<div class="main-products-page my-5 ">
    <h1 class="head-products-page">Edit Category Product</h1>
    <div class="form">
        <form class="form-product" action="edit-product-table.php" method="post" enctype="multipart/form-data">
